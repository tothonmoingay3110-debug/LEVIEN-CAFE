...
export default function MemberCard() {
  ...
  return <div className="memberCardPage">
    ...
    <article className="printMemberCard">
      <div className="memberCardBrand"><span className={content.logo ? "hasStoreLogo" : ""}>{content.logo ? <img src={content.logo} alt={`${content.storeName} logo`} /> : <b>LV</b>}</span><div><strong>{content.storeName}</strong><small>MEMBERSHIP</small></div></div>
