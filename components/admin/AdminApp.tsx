...
const viewLabels: Record<AdminView, string> = {
  ...
  toppings: "Toppings", combos: "Combos", combosuggestions: "Combo Suggestions", salespromotions: "Promotions", promotions: "Homepage Content", content: "Website Content", account: "My Account",
};
...
const adminNavGroups: AdminNavGroup[] = [
  ...
  { id: "store", label: "Customers & Store", shortLabel: "Store", icon: "products", views: ["customers", "loyalty", "giftcards", "products", "categories", "toppings", "combos", "combosuggestions", "salespromotions", "promotions", "content"] },
];
