  ...
  return (
    <footer className="siteFooter">
      <div className="footerGrid">
        ...
        <div><h3>Explore</h3><a href="/menu">Menu</a>{combos.length > 0 && <a href="/#combos">Combos</a>}<a href="/gift-card">Gift Cards</a><a href="/#story">Our Story</a><a href="/franchise">Franchise</a></div>
