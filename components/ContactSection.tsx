    ...
    <div className="contactInner">
      ...
      <form className="contactForm" onSubmit={submit}>
        ...
        <div className="contactFormGrid">
          ...
          <label><span className="fieldLabel">Subject <b>*</b></span><select name="subject" defaultValue="General question" required><option>General question</option><option>Order support</option><option>Catering</option><option>Franchise inquiry</option><option>Feedback</option><option>Other</option></select></label>
