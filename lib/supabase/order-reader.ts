...
export async function readSupabaseOrders(
  ...
  return orders.map((order) => {
    ...
    return {
      ...
      salesPromotionId: order.sales_promotion_id || undefined,
      salesPromotionName: order.promotion_snapshot && typeof order.promotion_snapshot === "object" && !Array.isArray(order.promotion_snapshot) && typeof order.promotion_snapshot.name === "string" ? order.promotion_snapshot.name : undefined,
